...
values (1, 'Bianchi Dessert', 'Per l''amor del gusto', '', 'Tétouan', 'Commandes tous les jours · 10h00 – 22h00', 'Retrait ou livraison le jour même selon le stock', true, 'Les commandes reprennent demain matin. À très vite !', true, 10, 0, 60, 'Livraison 10 DH à Tétouan, offerte dès 60 DH · Paiement à la réception · Stock du jour en direct')
on conflict (id) do nothing;
...
insert into public.produits (categorie_id, nom, description, prix, promo_label, stock, suivre_stock, ordre) values
  ...
  (6, 'Supplément caramel beurre salé — Petit', 'Nappage caramel beurre salé maison pour votre glace.', 2, '', null, false, 3),
  (6, 'Supplément caramel beurre salé — Grand', 'Nappage caramel beurre salé maison, grand format.', 4, '', null, false, 4),
...
update public.produits set traductions = '{"ar":{"nom":"إضافة كراميل بالزبدة المملحة — صغير","description":"صوص كراميل بالزبدة المملحة منزلي لمثلجاتك."},"en":{"nom":"Salted butter caramel topping — Small","description":"Homemade salted butter caramel sauce for your ice cream."},"de":{"nom":"Salzkaramell-Topping — Klein","description":"Hausgemachte Salzbutter-Karamellsauce für Ihr Eis."},"nl":{"nom":"Topping gezouten karamel — Klein","description":"Huisgemaakte karamelsaus met gezouten boter voor uw ijs."}}'::jsonb where nom = 'Supplément caramel beurre salé — Petit';
update public.produits set traductions = '{"ar":{"nom":"إضافة كراميل بالزبدة المملحة — كبير","description":"صوص كراميل بالزبدة المملحة منزلي، حجم كبير."},"en":{"nom":"Salted butter caramel topping — Large","description":"Homemade salted butter caramel sauce, large size."},"de":{"nom":"Salzkaramell-Topping — Groß","description":"Hausgemachte Salzbutter-Karamellsauce, große Portion."},"nl":{"nom":"Topping gezouten karamel — Groot","description":"Huisgemaakte karamelsaus met gezouten boter, groot formaat."}}'::jsonb where nom = 'Supplément caramel beurre salé — Grand';
...
update public.bannieres set traductions = '{"ar":{"titre":"عرض نهاية الأسبوع","texte":"اشترِ 3 كوكيز واحصل على الرابع مجاناً، يُذكر في ملاحظة الطلب."},"en":{"titre":"Weekend offer","texte":"Buy 3 cookies, get the 4th free. Mention it in your order note."},"de":{"titre":"Wochenend-Angebot","texte":"3 Cookies kaufen, den 4. gratis. Bitte in der Bestellanmerkung angeben."},"nl":{"titre":"Weekendaanbieding","texte":"Koop 3 koekjes, de 4e gratis. Vermeld het in de opmerking bij uw bestelling."}}'::jsonb where titre = 'Offre du week-end';
update public.parametres set traductions = '{"ar":{"horaires":"الطلبات كل يوم · 10:00 – 22:00","delai_texte":"استلام أو توصيل في نفس اليوم حسب المخزون","annonce":"جديد: اطلب عبر الإنترنت، المخزون المعروض هو مخزون اليوم · توصيل في تطوان · الدفع عند الاستلام","message_ferme":"تستأنف الطلبات صباح الغد. إلى اللقاء قريباً!"},"en":{"horaires":"Orders every day · 10:00 – 22:00","delai_texte":"Same-day pick-up or delivery, depending on stock","annonce":"New: order online, the stock shown is today''s · Delivery in Tétouan · Pay on delivery","message_ferme":"Orders resume tomorrow morning. See you soon!"},"de":{"horaires":"Bestellungen täglich · 10:00 – 22:00","delai_texte":"Abholung oder Lieferung am selben Tag, je nach Bestand","annonce":"Neu: online bestellen, der angezeigte Bestand ist der von heute · Lieferung in Tétouan · Zahlung bei Übergabe","message_ferme":"Bestellungen sind ab morgen früh wieder möglich. Bis bald!"},"nl":{"horaires":"Bestellingen elke dag · 10:00 – 22:00","delai_texte":"Afhalen of bezorging op dezelfde dag, afhankelijk van de voorraad","annonce":"Nieuw: bestel online, de getoonde voorraad is die van vandaag · Bezorging in Tétouan · Betaling bij ontvangst","message_ferme":"Bestellen kan morgenochtend weer. Tot snel!"}}'::jsonb where id = 1;
...
update public.parametres set traductions = '{"ar":{"horaires":"الطلبات كل يوم · 10:00 – 22:00","delai_texte":"استلام أو توصيل في نفس اليوم حسب المخزون","annonce":"توصيل 10 د.م. في تطوان، مجاني من 60 د.م. · الدفع عند الاستلام · مخزون اليوم مباشر","message_ferme":"تستأنف الطلبات صباح الغد. إلى اللقاء قريباً!"},"en":{"horaires":"Orders every day · 10:00 – 22:00","delai_texte":"Same-day pick-up or delivery, depending on stock","annonce":"Delivery 10 DH in Tétouan, free from 60 DH · Pay on delivery · Today''s stock, live","message_ferme":"Orders resume tomorrow morning. See you soon!"},"de":{"horaires":"Bestellungen täglich · 10:00 – 22:00","delai_texte":"Abholung oder Lieferung am selben Tag, je nach Bestand","annonce":"Lieferung 10 DH in Tétouan, kostenlos ab 60 DH · Zahlung bei Übergabe · Tagesbestand live","message_ferme":"Bestellungen sind ab morgen früh wieder möglich. Bis bald!"},"nl":{"horaires":"Bestellingen elke dag · 10:00 – 22:00","delai_texte":"Afhalen of bezorging op dezelfde dag, afhankelijk van de voorraad","annonce":"Bezorging 10 DH in Tétouan, gratis vanaf 60 DH · Betaling bij ontvangst · Voorraad van vandaag, live","message_ferme":"Bestellen kan morgenochtend weer. Tot snel!"}}'::jsonb where id = 1;
