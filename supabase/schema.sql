...
values (1, 'Bianchi Dessert', 'Per l''amor del gusto', '', 'Tétouan', 'Commandes tous les jours · 10h00 – 22h00', 'Retrait ou livraison le jour même selon le stock', true, 'Les commandes reprennent demain matin. À très vite !', true, 10, 0, 80, 'Nouveau : commandez en ligne, le stock affiché est celui du jour · Livraison à Tétouan · Paiement à la réception')
on conflict (id) do nothing;

insert into public.categories (id, nom, emoji, sous_titre, ordre) values
  (1, 'Charlottes', '🍎', 'La pièce signature, à partager', 1),
  (2, 'Beignets', '🍩', 'Moelleux, garnis à la commande', 2),
  (3, 'Cookies & Biscuits', '🍪', 'Croustillants dehors, fondants dedans', 3),
  (4, 'Tiramisù & Mousses', '🍰', 'En verrine individuelle', 4),
...
insert into public.bannieres (titre, texte, icone, style, ordre) values
  ('Offre du week-end', '3 cookies achetés = le 4ᵉ offert, à préciser en remarque de commande.', '🍪', 'or', 1);
