  ...
  function formProduit(p) {
    ...
    openModal(`
      ...
      <form id="fp" class="panel" style="box-shadow:none;padding:0;margin:0">
        ...
        <div class="field"><label>Étiquette promo <small>(facultatif · « Best-seller » est attribuée automatiquement au produit le plus vendu sur 30 jours ; la pièce du jour n'affiche jamais d'autre étiquette)</small></label><input name="promo_label" value="${esc(p.promo_label || "")}" placeholder="Nouveau · -20% · Édition limitée" list="promos"><datalist id="promos"><option>Nouveau</option><option>-20%</option><option>Promo</option><option>Édition limitée</option></datalist></div>
